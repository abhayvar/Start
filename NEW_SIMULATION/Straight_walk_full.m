...
time_left_arm_angles(4,105);
time_right_arm_angles(4,105);
...
for i=1:105
    fprintf('arm.move_joint([%f,%f,%f,%f,%f,%f,%f,%f,%f,%f])\n',-time_left_angles(3,i), -time_right_angles(2,i), -time_left_angles(5,i), -time_left_angles(2,i), time_right_angles(5,i), -time_right_angles(4,i), -time_left_angles(4,i), -time_right_angles(2,i), -time_left_angles(2,i), time_right_angles(3,i));
end